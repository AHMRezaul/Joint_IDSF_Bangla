...
MODEL_PATH_MAP = {
    # 'bert': 'bert-base-multilingual-cased', # to include mbert
    # 'bert': 'sagorsarker/bangla-bert-base', # to include bangla bert
    'bert': 'bert-base-uncased', # to include bert-base-uncased
...
def load_tokenizer(args):
    ...
    print(f"Tokenizer configuration: {tokenizer.init_kwargs}")
    
    # Test text in Bangla
    test_text = "আমি বাংলায় গান গাই।"  # Example Bangla text
    # Tokenize the text
